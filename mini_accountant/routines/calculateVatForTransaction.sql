CREATE OR REPLACE FUNCTION `invoicemaker-f5e1d.mini_accountant.calculateVatForTransaction`(transactionId INT64, vat NUMERIC, transactions ARRAY<STRUCT<DATETIME TIMESTAMP, SUM NUMERIC, EXCHANGE_RATE NUMERIC>>) RETURNS NUMERIC LANGUAGE js AS R"""
