CREATE OR REPLACE FUNCTION `invoicemaker-f5e1d.mini_accountant_admin.calculateVatForTransaction`(transactionId INT64, vat FLOAT64, transactions ARRAY<STRUCT<DATETIME TIMESTAMP, SUM NUMERIC, EXCHANGE_RATE NUMERIC>>) RETURNS NUMERIC LANGUAGE js AS R"""
