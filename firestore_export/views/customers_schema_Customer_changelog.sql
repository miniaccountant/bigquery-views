SELECT document_name,
  ...
  JSON_EXTRACT(data, '$.invoiceTableColumns') AS INVOICETABLECOLUMNS,
  `invoicemaker-f5e1d.firestore_export.firestoreBoolean`(JSON_EXTRACT(data, '$.invoiceSign')) AS INVOICESIGN,
  JSON_EXTRACT_SCALAR(data, '$.invoiceColor') AS INVOICECOLOR,
